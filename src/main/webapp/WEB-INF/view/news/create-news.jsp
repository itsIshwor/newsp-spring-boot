			...
			<div class="col-md-6 mx-auto  p-2 m-2">
				<form:form method="post" action="/news/save" modelAttribute="news">
					<div class="form-group">
						...
						<form:input id="title" path="title" class="form-control" placeholder="News Title"/>
					</div>
					
					<div class="form-group">
						<label for="">News Body</label>
					
						<form:textarea id="categories" path="newsBody" class="form-control" placeholder="News Details" rows="6"/>
					</div>
					<div class="form-group">
